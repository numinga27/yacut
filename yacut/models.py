...
from settings import (CREATED_SHORT_LINKS, CUSTOM_ID_LEN,
                      ITERATIONS_COUNT,
                      ORIGINAL_LEN, SHORT_LEN, REGULAR_EXPRESSION)
...
REGULAR_EXPRESSION_SHORT_ID = REGULAR_EXPRESSION + f'{{1,{SHORT_LEN}}}'
...
class URLMap(db.Model):
    ...
    def get_unique_short_id():
        for _ in range(ITERATIONS_COUNT):
            short_id = ''.join(random.sample(CREATED_SHORT_LINKS, CUSTOM_ID_LEN))
